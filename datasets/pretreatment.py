...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input_path', default='/home/wjj/casia-b/GaitDatasetB-silh', type=str, help='Root path of raw dataset.')
    parser.add_argument('-o', '--output_path', default='/home/wjj/tmp', type=str, help='Output path of pickled dataset.')
